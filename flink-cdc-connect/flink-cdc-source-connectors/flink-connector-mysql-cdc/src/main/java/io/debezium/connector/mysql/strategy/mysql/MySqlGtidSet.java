 ...
 */
@Immutable
public final class MySqlGtidSet implements GtidSet {
    ...
    public MySqlGtidSet(Map<String, UUIDSet> uuidSetsByServerId) {
    ...
    public static class UUIDSet {
        ...
        public UUIDSet(com.github.shyiko.mysql.binlog.GtidSet.UUIDSet uuidSet) {
