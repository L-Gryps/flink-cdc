...
public class XuGuConnection extends JdbcConnection {
    ...
    private static final String URL_PATTERN = "jdbc:xugu://${hostname}:${port}/${dbname}?";
    ...
    public List<TableId> getTables(String dbPattern, String tbPattern) throws SQLException {
        ...
        for (String schemaName : schemaNames) {
            List<String> tableNames =
                    getResultList(
                            metaData.getTables(null, schemaName, null, supportedTableTypes()),
                            "TABLE_NAME");
            tableNames.stream()
    ...
    //    @Override
    //    protected Optional<ColumnEditor> readTableColumn(ResultSet columnMetadata, TableId
    // tableId, Tables.ColumnNameFilter columnFilter) throws SQLException {
    //        return doReadTableColumn(columnMetadata, tableId, columnFilter);
    //    }
    //
    //    private Optional<ColumnEditor> doReadTableColumn(ResultSet columnMetadata, TableId
    // tableId, Tables.ColumnNameFilter columnFilter)
    //            throws SQLException {
